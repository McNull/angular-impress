...
(function (document, window, angular) {
  ...
  var impressSupported = // Browser should support CSS 3D transtorms
    ...
    (body.classList) && (body.dataset) && // But some mobile devices need to be blacklisted,
  ...
  ////////////////////////////////////////////////////////////////////////////////////
  // IMPRESS.JS API
  var ngImpressApi = angular.module('ngImpress.api', []);
  ngImpressApi.factory('impress', function ($timeout) {
